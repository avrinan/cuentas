...
class QRCaptureViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let cvc = segue.destination.contentViewController as? CuentasTableViewController {
            if let identifier = segue.identifier {
                if identifier == "done" {
                    cvc.codigoCapturado = messageMetaData
                }
            }
        }
    }
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            if let qrCodeFrameView = qrCodeFrameView {
                ...
                print("qrCodeFrameView not equal to qrCodeFrameView")
            }
