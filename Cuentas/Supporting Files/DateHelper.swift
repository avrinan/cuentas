...
public extension Date {
    ...
    func toString(style:DateStyleType = .short) -> String {
        ...
        case .yearMonth:
            return "\(self.component(.year)! * 100 + self.component(.month)!)"
        case .monthYear:
            return self.toString(format: .monthYear)
        }
    }
...
public enum DateFormatType {
    ...
    /// Date formatted as MMMM yyyy i.e. 'October 2018'
    case monthYear
...
public enum DateStyleType {
    case short, medium, long, full, weekday, shortWeekday, veryShortWeekday, month, shortMonth, veryShortMonth, yearMonth, monthYear
}
